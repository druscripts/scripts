...
public final class Constants {
    ...
    public static final int GAMES_NECKLACE = 3867; // missing
    public static final int SAPPHIRE_BRACELET = 11072; // or 11071
    ...
    // === Level 2 Emerald Items ===
    public static final int EMERALD_RING = 1639;
    public static final int RING_OF_DUELING = 2566; // missing
    public static final int EMERALD_NECKLACE = 1658;
    public static final int BINDING_NECKLACE = 5521;
    public static final int EMERALD_BRACELET = 11076; // or 11078
    public static final int CASTLE_WARS_BRACELET = 11079; // 11079 (3); 11081 (2); 11083 (1)
    ...
    public static final int RING_OF_RETURNING = 21129; // 22129 (5); 21132 (4); 21134 (3); 21136 (2); 21138 (1)
    public static final int JADE_NECKLACE = 21093;
    public static final int NECKLACE_OF_PASSAGE = 21155; // missing
    ...
    public static final int DIGSITE_PENDANT = 11190; // missing
    public static final int RUBY_BRACELET = 11085; // or 11087
    ...
    public static final int BURNING_AMULET = 21175; // missing

    // === Level 4 Diamond Items ===
    ...
    public static final int DIAMOND_BRACELET = 11092; // or 11094
    public static final int ABYSSAL_BRACELET = 11095; // 11095 (5), 11097 (4), 11099 (3), 11101 (2) 11103 (1)
    public static final int DIAMOND_AMULET = 1700;
    public static final int AMULET_OF_POWER = 1731; // or 20585

    // === Level 5 Dragonstone Items ===
    public static final int DRAGONSTONE_RING = 1645;
    public static final int RING_OF_WEALTH_UNCHARGED = 2572; // missing
    public static final int DRAGONSTONE_NECKLACE = 1664; // missing
    public static final int SKILLS_NECKLACE_UNCHARGED = 11113;
    public static final int DRAGONSTONE_BRACELET = 11115;
    public static final int COMBAT_BRACELET_UNCHARGED = 11126;
    ...
    public static final int ONYX_BRACELET = 11130; // or 11132
    public static final int REGEN_BRACELET = 11133;
    public static final int ONYX_AMULET = 6581;
    public static final int AMULET_OF_FURY = 6585; // or 23640

    // === Level 7 Zenyte Items ===
    ...
    public static final int ZENYTE_BRACELET = 19532; // or 19492
    public static final int TORMENTED_BRACELET = 19544; // or 27171
    public static final int ZENYTE_AMULET = 19541;
    public static final int AMULET_OF_TORTURE = 19553; // or 27173

    // === Enchant Spell Sprite IDs (when runes available) ===
    public static final int ENCHANT_SPRITE_LVL_1 = 1765;
    public static final int ENCHANT_SPRITE_LVL_2 = 1766;
    public static final int ENCHANT_SPRITE_LVL_3 = 1767;
    public static final int ENCHANT_SPRITE_LVL_4 = 1768;
    public static final int ENCHANT_SPRITE_LVL_5 = 1769;
    public static final int ENCHANT_SPRITE_LVL_6 = 1770;
    public static final int ENCHANT_SPRITE_LVL_7 = 1771;

    // === Submenu Back Button Sprite IDs ===
